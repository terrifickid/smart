...
<div>
  <header class="relative z-10 ">
    <div
      class=" w-screen mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-wrap items-center justify-center sm:justify-between lg:flex-nowrap"
    >
      <div class="mt-10 lg:mt-0 lg:grow lg:basis-0" />
      <div
        class="order-first -mx-4 flex flex-auto basis-full overflow-x-auto whitespace-nowrap border-b border-blue-600/10 py-4 font-mono text-sm text-blue-600 sm:-mx-6 "
      >
        <div class="mx-auto flex items-center gap-4 px-4">
          <p>
            <time datetime="2022-04-04">04</time>-<time datetime="2022-04-06"
              >06 of April, 2022</time
            >
          </p>
          <svg
            aria-hidden="true"
  ...
  <div class="relative pt-10 pb-20 sm:py-24">
    <div
      class="absolute inset-x-0 -top-48 -bottom-14 overflow-hidden bg-indigo-50"
    >
      <img
        alt=""
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
      <div class="mx-auto max-w-2xl lg:max-w-4xl lg:px-12">
        <svg
          aria-hidden="true"
          viewBox="0 0 183 48"
          class="h-12 w-auto text-slate-900 mb-20"
          ><path
            fill="#3B82F6"
            fill-rule="evenodd"
        ...
        >
          <span class="sr-only">DeceptiConf - </span>A design conference for the
          dark side.
        </h1>
        <div
        ...
        >
        <dl
          class="mt-10 grid grid-cols-2 gap-y-6 gap-x-10 sm:mt-16 sm:gap-y-10 sm:gap-x-16 sm:text-center lg:auto-cols-auto lg:grid-flow-col lg:grid-cols-none lg:justify-start lg:text-left"
        >
          <div>
